        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <Card style={{ flex: 1, marginRight: numColumns > 1 ? 8 : 0 }}>
              ...
              />
              <Card.Actions>
                <Button onPress={() => dispatch(toggleTodo(item.id))} textColor="#1cb4ad">
                  Done
                </Button>
                <Button
                  mode="contained"
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <Card style={{ flex: 1, marginRight: numColumns > 1 ? 8 : 0 }}>
              ...
              />
              <Card.Actions>
                <Button onPress={() => dispatch(toggleTodo(item.id))} textColor="#b41c1cff">
                  Undo
                </Button>
                <Button
                  mode="contained"
...
const styles = StyleSheet.create({
  ...
  containerTablet: { paddingHorizontal: 15 },
  content: { flex: 1, padding: 12 },
  contentTablet: { flexDirection: "row", gap: 19 },
  column: { flex: 1 },
  columnTablet: { flex: 1 },
  card: { marginBottom: 15, borderRadius: 20, overflow: "hidden" },
